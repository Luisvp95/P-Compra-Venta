...
class UpdateRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'ci'=>'nullable|numeric|unique:clients,ci,'. $this->route('client')->id.'|digits_between:6,10',
            'address'=>'nullable|string|max:255',
            'phone'=>'nullable|numeric|unique:clients,phone,'. $this->route('client')->id.'|digits:8',
            'email'=>'nullable|unique:clients,email,'. $this->route('client')->id.'|max:50|email:rfc,dns',
